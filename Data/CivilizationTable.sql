...
(	'CHINA_PRC',	'StandardPlayers',	NULL,					NULL,					'RED',			'ASIAN',	'BEIJING',		'P.R.C.',			'Chinese',		'Peoples Republic of China',			'Chinese Government'		),
(	'CHINA_ROC',	'StandardPlayers',	NULL,					NULL,					'WHITE',		'ASIAN',	'TAIPEI',		'Taiwan',			'Taiwanese',	'Republic of China',					'Taiwanese Government'		),
...
(	'KENYA',		'StandardPlayers',	NULL,					NULL,					'BLACK',		'AFRICAN',	'NAIROBI',		'Kenya',			'Kenyan',		'Republic of Kenya',                    'Kenyan Government'		),
...
(	'SOUTH_KOREA',	'StandardPlayers',	NULL,					NULL,					'WHITE',		'ASIAN',	'SEOUL',		'South Korea',		'South Korean',	'Republic of Korea',					'South Korean Government'	),
...
--(	'SWEDEN',		'StandardPlayers',	NULL,					NULL,					'YELLOW',		'EURO',		'STOCKHOLM',	'Sweden',			'Swedish',		'Kingdom of Sweden',					'Swedish Government'		), -- cause a crash on load, I suppose because of an entry in artdef from vanilla using CIVILIZATION_SWEDEN, question is why no crash for other similar cases ?
(	'SWEDEN_FIX',	'StandardPlayers',	NULL,					NULL,					'YELLOW',		'EURO',		'STOCKHOLM',	'Sweden',			'Swedish',		'Kingdom of Sweden',					'Swedish Government'		),
...
(	'UK',			'StandardPlayers',	'ENGLAND_PRIMARY',		'ENGLAND_SECONDARY',	'WHITE',		'EURO',		'LONDON',		'U.K.', 			'British',		'United Kingdom',						'British Government'		),
