...
(	'AMERICA',		'Players:StandardPlayers',	NULL,					NULL,					'WHITE',		'SOUTHAM',	'WASHINGTON',	'U.S.A.', 			'American',		'United States of America',				'American Government'		),
...
(	'CHINA_PRC',	'Players:StandardPlayers',	NULL,					NULL,					'RED',			'ASIAN',	'BEIJING',		'P.R.C.',			'Chinese',		'Peoples Republic of China',			'Chinese Government'		),
...
--(	'SWEDEN',		'Players:StandardPlayers',	NULL,					NULL,					'YELLOW',		'EURO',		'STOCKHOLM',	'Sweden',			'Swedish',		'Kingdom of Sweden',					'Swedish Government'		), -- cause a crash on load, I suppose because of an entry in artdef from vanilla using CIVILIZATION_SWEDEN, question is why no crash for other similar cases ?
...
(	'UK',			'Players:StandardPlayers',	'ENGLAND_PRIMARY',		'ENGLAND_SECONDARY',	'WHITE',		'EURO',		'LONDON',		'U.K.', 			'British',		'United Kingdom',						'British Government'		),
