...
(	'DENMARK',		'MIDDLE_BLUE',		'RED',					'WHITE',		'EURO',		'COPENHAGEN',	'Denmark',			'Danish',		'Kingdom of Denmark',					'Danish Governement'		),
(	'PERU',			'RED',				'MIDDLE_BLUE',			'WHITE',		'SOUTHAM',	'LIMA',			'Peru',				'Peruvian',		'Republic of Peru',            			'Peruvian Governement'		),
(	'PHILIPPINES',	'NORWAY_PRIMARY',	'NORWAY_SECONDARY',		'WHITE',		'ASIAN',	'MANILA',		'The Philippines',	'Philippine',	'Republic of the Philippines',          'Philippine Governement'	),
(	'MALAYSIA',		'WHITE',			'PALE_RED',				'WHITE',		'ASIAN',	'KUALA_LUMPUR',	'Malaysia',			'Malaysian',	'Federation of Malaysia',               'Malaysian Governement'		),
(	'UZBEKISTAN',	'GREEN',			'RED',					'YELLOW',		'ASIAN',	'TASHKENT',		'Uzbekistan',		'Uzbekistani',	'Republic of Uzbekistan',               'Uzbekistani Governement'   ),
(	'NIGERIA',		'RUSSIA_PRIMARY',	'RUSSIA_SECONDARY',		'WHITE',		'AFRICAN',	'ABUJA',		'Nigeria',			'Nigerian',		'Federal Republic of Nigeria',          'Nigerian Governement'		),
(	'PAKISTAN',		'DARK_GREEN',		'RED',					'BLUE',			'ASIAN',	'ISLAMABAD',	'Pakistan',			'Pakistani',	'Islamic Republic of Pakistan',         'Pakistani Governement'		),
(	'VENEZUELA',	'BLUE',				'RED',					'WHITE',		'SOUTHAM',	'CARACAS',		'Venezuela',		'Venezuelan',	'Bolivarian Republic of Venezuela',     'Venezuelan Governement'	),
(	'ANGOLA',		'SPAIN_PRIMARY',	'SPAIN_SECONDARY',		'RED',			'AFRICAN',	'LUANDA',		'Angola',			'Angolan',		'Republic of Angola',                   'Angolan Governement'		),
(	'SUDAN',		'YELLOW',			'BLUE',					'YELLOW',		'AFRICAN',	'KHARTOUM',		'Sudan',			'Sudanese',		'Republic of the Sudan',                'Sudanese Governement'		),
(	'TANZANIA',		'MIDDLE_BLUE',		'WHITE',				'RED',			'AFRICAN',	'DODOMA',		'Tanzania',			'Tanzanian',	'United Republic of Tanzania',          'Tanzanian Governement'		),
(	'CHILE',		'RED',				'WHITE',				'RED',			'SOUTHAM',	'SANTIAGO',		'Chile',			'Chilean',		'Republic of Chile',                    'Chilean Governement'		),
(	'ROMANIA',		'ENGLAND_PRIMARY',	'ENGLAND_SECONDARY',	'WHITE',		'EURO',		'BUCHAREST',	'Romania',			'Romanian',		'Romania',                              'Romanian Governement'		),
(	'MYANMAR',		'YELLOW',			'LIGHT_BLUE',			'YELLOW',		'ASIAN',	'NAYPYIDAW',	'Myanmar',			'Burmese',		'Republic of the Union of Myanmar',		'Burmese Governement'		),
(	'KENYA',		'YELLOW',			'PALE_RED',				'RED',			'AFRICAN',	'NAIROBI',		'Kenya',			'Kenyan',		'Republic of Kenya',                    'Kenyan Governement'		),
