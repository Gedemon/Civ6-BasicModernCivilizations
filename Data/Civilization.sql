...
(	'KONGO',		'KONGO_PRIMARY',	'BLUE',					'WHITE',		'AFRICAN',	'KINCHASSA',	'Kongo', 		'Kongolese',	'Kongolese Empire',			'Kongolese Governement'		),
...
(	'MALI',			'YELLOW',			'RED',					'WHITE',		'AFRICAN',	'BAMAKO',		'Mali', 		'Malinese',		'Malinese Empire',			'Malinese Governement'		),
...
(	'SOUTH_AFRICA',	'DARK_GREEN',		'RED',					'BLUE',			'AFRICAN',	'CAPE_TOWN',	'South Africa',	'South African','South African Empire',		'South African Governement'	),
...
(	'CHINA_ROC',	'LIGHT_BLUE',		'RED',					'WHITE',		'ASIAN',	'TAIPEI',		'RO China',		'Chinese',		'Republic of China',		'RO China Governement'		),
...
(	'CUBA',			'PALE_RED',			'BLUE',					'WHITE',		'SOUTHAM',	'HAVANA',		'Cuba',			'Cuban',		'Cuban Empire',				'Cuban Governement'			),
